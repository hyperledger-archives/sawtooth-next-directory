    ...
    def test_00_create_users(self):
        ...
        self.assertEqual(
            self.client.create_user(
                ...
                next_id=self.key_manager.public_key,
        ...
        with self.assertRaises(ValueError) as err:
            self.client.create_user(
                ...
                next_id=self.key_invalid.public_key,
                manager_id=None,
            )
