...
from rbac.common.addresser.sysadmin import SysAdminOwnerAddress
...
@pytest.mark.unit
class TestSysAdminOwnerAddresser(AddressAssertions):
    def test_import(self):
        self.assertIsInstance(addresser.sysadmin, SysAdminAddress)
        self.assertIsInstance(addresser.sysadmin.owner, SysAdminOwnerAddress)
        self.assertIsAddressClass(addresser.sysadmin.owner)
