...
@pytest.mark.role
class RejectRoleAddOwnerTest(RoleTestHelper):
    ...
    def test_interface(self):
        ...
        self.assertIsInstance(self.role.owner.reject, RejectAddRoleOwner)
        self.assertTrue(callable(self.role.owner.reject.address))
        self.assertTrue(callable(self.role.owner.reject.make))
        self.assertTrue(callable(self.role.owner.reject.make_addresses))
        self.assertTrue(callable(self.role.owner.reject.make_payload))
        self.assertTrue(callable(self.role.owner.reject.create))
        self.assertTrue(callable(self.role.owner.reject.send))
        self.assertTrue(callable(self.role.owner.reject.get))
    ...
    def test_make(self):
        ...
        message = self.role.owner.reject.make(
    ...
    def test_make_addresses(self):
        ...
        inputs, outputs = self.role.owner.reject.make_addresses(
    ...
    def test_make_payload(self):
        ...
        self.assertTrue(callable(self.role.owner.reject.make_payload))
        message, owner_key = self.test_make()
        payload = self.role.owner.reject.make_payload(
            message=message, signer_keypair=owner_key
        )

        proposal_address = self.role.owner.reject.address(
