...
@pytest.mark.task
class RejectTaskAddAdminTest(TaskTestHelper):
    ...
    def test_interface(self):
        ...
        self.assertIsInstance(self.task.admin.reject, RejectAddTaskAdmin)
        self.assertTrue(callable(self.task.admin.reject.address))
        self.assertTrue(callable(self.task.admin.reject.make))
        self.assertTrue(callable(self.task.admin.reject.make_addresses))
        self.assertTrue(callable(self.task.admin.reject.make_payload))
        self.assertTrue(callable(self.task.admin.reject.create))
        self.assertTrue(callable(self.task.admin.reject.send))
        self.assertTrue(callable(self.task.admin.reject.get))
    ...
    def test_make(self):
        ...
        message = self.task.admin.reject.make(
    ...
    def test_make_addresses(self):
        ...
        inputs, outputs = self.task.admin.reject.make_addresses(
    ...
    def test_make_payload(self):
        ...
        self.assertTrue(callable(self.task.admin.reject.make_payload))
        message, owner_key = self.test_make()
        payload = self.task.admin.reject.make_payload(
            message=message, signer_keypair=owner_key
        )

        proposal_address = self.task.admin.reject.address(
            object_id=message.task_id, target_id=message.user_id
        )
    ...
    def test_create(self):
        ...
        proposal, owner_key = self.get_testdata_task_admin_proposal()
        reason = self.get_testdata_reason()
        message = self.task.admin.reject.make(
        ...
        got, status = self.task.admin.reject.create(
