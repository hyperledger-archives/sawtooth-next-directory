...
# -----------------------------------------------------------------------------
"""Test Propose Task Admin Helper"""
...
@pytest.mark.task
class ProposeTaskAdminHelperTest(TestAssertions):
    """Test Propose Task Admin Helper"""

    @pytest.mark.library
    def test_id(self):
        """Test get a random proposal id"""
        id1 = helper.task.admin.propose.id()
        id2 = helper.task.admin.propose.id()
    ...
    def test_reason(self):
        ...
        reason1 = helper.task.admin.propose.reason()
        reason2 = helper.task.admin.propose.reason()
    ...
    def test_create(self):
        ...
        proposal, task, task_owner, task_owner_key, user, user_key = (
            helper.task.admin.propose.create()
        )
