...
def validate_role_admin_or_owner(header, confirm, txn_signer_rel_address, state):
...
def handle_reject(state_entries, header, reject, state, rel_type="user_id"):
    proposal_address = addresser.make_proposal_address(
