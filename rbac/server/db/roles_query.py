...
async def fetch_role_resource(conn, role_id, head_block_num):
    ...
    try:
        ...
        raise ApiNotFound("Role Not Found: Could not find any role with ID {} .".format(role_id))
...
async def fetch_recommended_resources(conn, identifier, head_block_num, start, limit):
    ...
    try:
        ...
        raise ApiNotFound("Not Found: Could not find role with identifier {}".format(identifier))
