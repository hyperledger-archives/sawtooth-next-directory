...
class RejectAddRoleMember(BaseMessage):
    def __init__(self):
    ...
    def message_type(self):
        ...
        return protobuf.rbac_payload_pb2.RBACPayload.REJECT_ADD_ROLE_MEMBER

    @property
    def message_proto(self):
        return protobuf.role_transaction_pb2.RejectAddRoleMember
