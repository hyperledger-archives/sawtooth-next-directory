...
class ConfirmAddTaskOwner(BaseMessage):
    def __init__(self):
    ...
    def message_type(self):
        return protobuf.rbac_payload_pb2.RBACPayload.CONFIRM_ADD_TASK_OWNERS

    @property
    def message_proto(self):
        return protobuf.task_transaction_pb2.ConfirmAddTaskOwner
    ...
    def make_addresses(self, message, signer_keypair):
        ...
        signer_owner_address = addresser.make_task_owners_address(
            task_id=message.task_id, user_id=signer_keypair.public_key
        )
