...
class TestAddresser(unittest.TestCase):
    ...
    def test_sysadmin_addresses(self):
        ...
        self.assertEqual(len(sysadmin_members_address), 70,
                         "The address is a well-formed address.")
        ...
        self.assertEqual(len(sysadmin_owners_address), 70,
                         "The address is a well-formed address.")
        ...
        self.assertEqual(len(sysadmin_admins_address), 70,
                         "The address is a well-formed address.")
    ...
    def test_task_addresses(self):
        ...
        self.assertEqual(len(task_address), 70,
                         "The address is a well-formed address.")
        ...
        self.assertEqual(len(task_owners_address), 70,
                         "The address is a well-formed address.")
        ...
        self.assertEqual(len(task_admins_address), 70,
                         "The address is a well-formed address.")
    ...
    def test_users_address(self):
        ...
        users_address = addresser.make_user_address(
            user_id=uuid4().hex)

        self.assertEqual(len(users_address), 70,
                         "The address is a well-formed address.")

        self.assertEqual(
            addresser.address_is(users_address),
            AddressSpace.USER,
            "The User address created must be found "
            "to be a User address.")
